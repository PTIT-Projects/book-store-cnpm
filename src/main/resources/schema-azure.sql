...
VALUES (1, 'a', '123456', 'A', N'Nhân viên kho')
...
INSERT [dbo].[tblImportBill] ([id], [import_date], [sale_off], [payment_method], [note], [user_id], [provider_id]) VALUES (5, CAST(N'2025-05-01' AS Date), 100000, N'Chuyển khoản', N'Giảm 100000 cho lần nhập đầu tiên', CAST(1 AS Numeric(18, 0)), CAST(2 AS Numeric(18, 0)))
INSERT [dbo].[tblImportBill] ([id], [import_date], [sale_off], [payment_method], [note], [user_id], [provider_id]) VALUES (6, CAST(N'2025-05-01' AS Date), 100000, N'Thẻ tín dụng', N'Giảm giá do thanh toán bằng thẻ tín dụng', CAST(1 AS Numeric(18, 0)), CAST(3 AS Numeric(18, 0)))
INSERT [dbo].[tblImportBill] ([id], [import_date], [sale_off], [payment_method], [note], [user_id], [provider_id]) VALUES (7, CAST(N'2025-05-01' AS Date), 1000000, N'Chuyển khoản', N'Giảm giá 1 triệu đồng', CAST(1 AS Numeric(18, 0)), CAST(3 AS Numeric(18, 0)))
INSERT [dbo].[tblImportBill] ([id], [import_date], [sale_off], [payment_method], [note], [user_id], [provider_id]) VALUES (8, CAST(N'2025-05-01' AS Date), 0, N'Tiền mặt', N'', CAST(1 AS Numeric(18, 0)), CAST(5 AS Numeric(18, 0)))
INSERT [dbo].[tblImportBill] ([id], [import_date], [sale_off], [payment_method], [note], [user_id], [provider_id]) VALUES (9, CAST(N'2025-05-01' AS Date), 220000, N'Thẻ tín dụng', N'', CAST(1 AS Numeric(18, 0)), CAST(4 AS Numeric(18, 0)))
INSERT [dbo].[tblImportBill] ([id], [import_date], [sale_off], [payment_method], [note], [user_id], [provider_id]) VALUES (10, CAST(N'2025-05-01' AS Date), 1000000, N'Chuyển khoản', N'', CAST(1 AS Numeric(18, 0)), CAST(6 AS Numeric(18, 0)))
SET IDENTITY_INSERT [dbo].[tblImportBill] OFF

-- Insert ImportedBookTitle data
SET IDENTITY_INSERT [dbo].[tblImportedBookTitle] ON 
INSERT [dbo].[tblImportedBookTitle] ([id], [quantity], [unit_price], [import_bill_id], [book_title_id]) VALUES (1, 20, 30000, CAST(5 AS Numeric(18, 0)), CAST(1 AS Numeric(18, 0)))
INSERT [dbo].[tblImportedBookTitle] ([id], [quantity], [unit_price], [import_bill_id], [book_title_id]) VALUES (2, 30, 30000, CAST(6 AS Numeric(18, 0)), CAST(1 AS Numeric(18, 0)))
INSERT [dbo].[tblImportedBookTitle] ([id], [quantity], [unit_price], [import_bill_id], [book_title_id]) VALUES (3, 20, 30000, CAST(7 AS Numeric(18, 0)), CAST(3 AS Numeric(18, 0)))
INSERT [dbo].[tblImportedBookTitle] ([id], [quantity], [unit_price], [import_bill_id], [book_title_id]) VALUES (4, 40, 100000, CAST(7 AS Numeric(18, 0)), CAST(4 AS Numeric(18, 0)))
INSERT [dbo].[tblImportedBookTitle] ([id], [quantity], [unit_price], [import_bill_id], [book_title_id]) VALUES (5, 30, 30000, CAST(8 AS Numeric(18, 0)), CAST(2 AS Numeric(18, 0)))
INSERT [dbo].[tblImportedBookTitle] ([id], [quantity], [unit_price], [import_bill_id], [book_title_id]) VALUES (6, 20, 100000, CAST(8 AS Numeric(18, 0)), CAST(4 AS Numeric(18, 0)))
INSERT [dbo].[tblImportedBookTitle] ([id], [quantity], [unit_price], [import_bill_id], [book_title_id]) VALUES (7, 20, 30000, CAST(9 AS Numeric(18, 0)), CAST(3 AS Numeric(18, 0)))
INSERT [dbo].[tblImportedBookTitle] ([id], [quantity], [unit_price], [import_bill_id], [book_title_id]) VALUES (8, 30, 500000, CAST(10 AS Numeric(18, 0)), CAST(5 AS Numeric(18, 0)))
INSERT [dbo].[tblImportedBookTitle] ([id], [quantity], [unit_price], [import_bill_id], [book_title_id]) VALUES (9, 0, 550000, CAST(10 AS Numeric(18, 0)), CAST(6 AS Numeric(18, 0)))
